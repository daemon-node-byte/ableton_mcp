...
_COMMAND_SPECS = [
    ...
    _spec("get_rack_chains", "rack", required=("track_index", "device_index"), result="{rack_name, chains[]}", stability="confirmed", exposed=True, notes="Validated in Ableton Live 12 locally on 2026-04-09. Generic Instrument Rack and Audio Effect Rack device entries load as empty shells in the current Live library, while populated chain validation was proven on a loaded Drum Rack."),
    _spec("get_rack_macros", "rack", required=("track_index", "device_index"), result="{rack_name, macros[]}", stability="confirmed", exposed=True, notes="Validated in Ableton Live 12 locally on 2026-04-09. Returns stable macro indices for read/write use."),
    _spec("set_rack_macro", "rack", required=("track_index", "device_index", "macro_index", "value"), result="{name, value}", write=True, stability="confirmed", exposed=True, notes="Validated in Ableton Live 12 locally on 2026-04-09. Macro writes clamp to the parameter range."),
    _spec("get_chain_devices", "rack", required=("track_index", "device_index", "chain_index"), result="{chain_name, devices[]}", stability="confirmed", exposed=True, notes="Validated in Ableton Live 12 locally on 2026-04-09 on populated Drum Rack chains. Chain lookup is bounds-checked."),
    _spec("set_chain_mute", "rack", required=("track_index", "device_index", "chain_index", "mute"), result="{mute}", write=True, stability="confirmed", exposed=True, notes="Validated in Ableton Live 12 locally on 2026-04-09 on populated Drum Rack chains. Chain lookup is bounds-checked."),
    _spec("set_chain_solo", "rack", required=("track_index", "device_index", "chain_index", "solo"), result="{solo}", write=True, stability="confirmed", exposed=True, notes="Validated in Ableton Live 12 locally on 2026-04-09 on populated Drum Rack chains. Chain lookup is bounds-checked."),
    _spec("set_chain_volume", "rack", required=("track_index", "device_index", "chain_index", "volume"), result="{volume}", write=True, stability="confirmed", exposed=True, notes="Validated in Ableton Live 12 locally on 2026-04-09 on populated Drum Rack chains. Chain volume writes clamp to the supported range."),
